...
| label 改用 close1500（15:00 分钟收盘，两腿同源） | W1 改善为单窗运气，W2 崩塌 + purged 胜率 21%；混合基准"噪声"实为可学习且样本外持续的序列分歧结构，回测结算语义下现役 label 是忠实定义 | [close1500 label](backtest-log/2026-09-12-label-close1500.md) |
